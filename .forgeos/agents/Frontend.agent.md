...
4. Read all chunk files in `.forgeos/skills/Frontend/`.
...
1. Write summary to `.forgeos/agent-output/Frontend/{ticket-id}.md` (files, tests, a11y audit, breakpoints).
...
4. Append to `.forgeos/memory-bank/activeContext.md`:
...
## 11. References
- [.forgeos/instructions/*.instructions.md](../.forgeos/instructions/*.instructions.md) (all 6 files)
- [.forgeos/skills/Frontend/](../.forgeos/skills/Frontend/)
