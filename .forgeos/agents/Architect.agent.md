...
4. Read `.forgeos/skills/Architect/` (all chunk files)
...
1. Write summary to `.forgeos/agent-output/Architect/{ticket-id}.md`
...
## 10. References
- [.forgeos/instructions/*.instructions.md](../.forgeos/instructions/*.instructions.md) (5 canonical rule files)
- [.forgeos/skills/Architect/](../.forgeos/skills/Architect/) (domain expertise chunks)
