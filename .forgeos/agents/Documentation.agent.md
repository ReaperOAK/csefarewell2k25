...
1. Read `.forgeos/guardian/STOP_ALL` — if `STOP`, halt immediately, zero edits.
2. Read all 6 files in `.forgeos/instructions/` (core, sdlc, ticket-system, git-protocol, agent-behavior, terminal-management).
3. Read upstream summary: `.forgeos/agent-output/CIReviewer/{ticket-id}.md`.
4. Read all files in `.forgeos/skills/Documentation/`.
...
1. Write summary to `.forgeos/agent-output/Documentation/{ticket-id}.md`.
2. Delete upstream summary: `.forgeos/agent-output/CIReviewer/{ticket-id}.md`.
...
- [.forgeos/skills/Documentation/](../.forgeos/skills/Documentation/)
