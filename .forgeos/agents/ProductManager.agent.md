...
3. Read upstream context from `.forgeos/agent-output/{PreviousAgent}/{ticket-id}.md`
4. Read `.forgeos/skills/ProductManager/` (all chunks)
...
- Does NOT run `.forgeos/tickets.py --claim` or `.forgeos/tickets.py --advance`
...
| Agent summary | `.forgeos/agent-output/ProductManager/{ticket-id}.md` | Standard summary |
| Memory entry | `.forgeos/memory-bank/activeContext.md` | Append-only, ISO8601 timestamp |
...
- [.forgeos/skills/ProductManager/](../.forgeos/skills/ProductManager/)
