...
REQUIRED: Write summary to `.forgeos/agent-output/{AgentName}/{ticket-id}.md`.
...
RULE: `.forgeos/tickets.py --release-expired` clears stale claims.
...
RULE: Location: `.forgeos/agent-output/{AgentName}/{ticket-id}.md`
