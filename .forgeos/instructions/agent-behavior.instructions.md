...
4. Instruction files (`.forgeos/instructions/`)
5. Agent skill files (`.forgeos/skills/` — SKILL.md and references)
...
RULE: Git + .forgeos/tickets.py enforce safety. Not Ticketer.
