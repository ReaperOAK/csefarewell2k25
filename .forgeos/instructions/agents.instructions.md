...
- Location: `.forgeos/agents/` directory (repository-level) or `agents/` directory (organization/enterprise-level)
...
Spec: .forgeos/agents/data-processor.agent.md
...
Agent: data-analyst
Spec: .forgeos/agents/data-analyst.agent.md
Context: projectName=${projectName}, basePath=${basePath}
...
```text
This phase must be performed as the agent "documentation-writer" defined in ".forgeos/agents/documentation-writer.agent.md".
...
Spec: .forgeos/agents/security-reviewer.agent.md
...
Agent: test-coverage
Spec: .forgeos/agents/test-coverage.agent.md
Context: repositoryName=${repositoryName}, prNumber=${prNumber}, basePath=projects/${repositoryName}/pr-${prNumber}
Output: projects/${repositoryName}/pr-${prNumber}/coverage-report.md

Step 3: Aggregate
Agent: review-aggregator
Spec: .forgeos/agents/review-aggregator.agent.md
Context: repositoryName=${repositoryName}, prNumber=${prNumber}, basePath=projects/${repositoryName}/pr-${prNumber}
...
```text
This phase must be performed as the agent "security-reviewer" defined in ".forgeos/agents/security-reviewer.agent.md".
...
- [ ] File placed in correct directory (`.forgeos/agents/` or `agents/`)
