...
|----------|-------|----------------|
| `.forgeos/skills/<skill-name>/` | Project/repository | Recommended for project skills |
| `.claude/skills/<skill-name>/` | Project/repository | Legacy, for backward compatibility |
| `~/.forgeos/skills/<skill-name>/` | Personal (user-wide) | Recommended for personal skills |
