...
description: 'Prompt for generating an .forgeos/AGENTS.md file for a repository'
---

# Create high‑quality .forgeos/AGENTS.md file

You are a code agent. Your task is to create a complete, accurate .forgeos/AGENTS.md at the root of this repository that follows the public guidance at https://agents.md/.

.forgeos/AGENTS.md is an open format designed to provide coding agents with the context and instructions they need to work effectively on a project.

## What is .forgeos/AGENTS.md?

.forgeos/AGENTS.md is a Markdown file that serves as a "README for agents" - a dedicated, predictable place to provide context and instructions to help AI coding agents work on your project. It complements README.md by containing detailed technical context that coding agents need but might clutter a human-focused README.
...
- Create the file as `.forgeos/AGENTS.md` in the repository root
...
- **Consider nested files**: For monorepos, create .forgeos/AGENTS.md files in subprojects as needed

## Monorepo Considerations

For large monorepos:

- Place a main .forgeos/AGENTS.md at the repository root
- Create additional .forgeos/AGENTS.md files in subproject directories
- The closest .forgeos/AGENTS.md file takes precedence for any given location
- Include navigation tips between packages/projects

## Final Notes

- .forgeos/AGENTS.md works with 20+ AI coding tools including Cursor, Aider, Gemini CLI, and many others
...
When creating the .forgeos/AGENTS.md file, prioritize clarity, completeness, and actionability. The goal is to give any coding agent enough context to effectively contribute to the project without requiring additional human guidance.
