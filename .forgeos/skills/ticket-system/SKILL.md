---
name: ticket-system
description: File-based ticket state machine. Quick reference for ticket operations, stage directories, and .forgeos/tickets.py commands.
...
File-based ticket state machine. Quick reference for ticket operations, stage directories, and .forgeos/tickets.py commands.
