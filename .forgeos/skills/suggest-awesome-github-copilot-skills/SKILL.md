...
2. **Scan Local Skills**: Discover existing skill folders in `.forgeos/skills/` folder
...
12. **Download/Update Assets**: For requested skills, automatically:
    - Download new skills to `.forgeos/skills/` folder, preserving the folder structure
...
1. List all folders in `.forgeos/skills/` directory
...
- Scan local file system for existing skills in `.forgeos/skills/` directory
...
5. Preserve folder location in `.forgeos/skills/` directory
