...
# Purpose: Check .forgeos/guardian/STOP_ALL for emergency stop signal
# Exit 0 = allow, Exit 1 = block

set -euo pipefail

GUARDIAN_FILE=".forgeos/guardian/STOP_ALL"
...
if grep -q "^STOP$" "$GUARDIAN_FILE" 2>/dev/null; then
    echo "GUARDIAN HALT: .forgeos/guardian/STOP_ALL contains STOP signal." >&2
